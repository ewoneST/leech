...
def start(update, context):
    buttons = ButtonMaker()
    if config_dict['EMOJI_THEME']:
        buttons.buildbutton(f"😎 {config_dict['ST_Master']}", f"{config_dict['https://t.me/STThamizhan']}")
        buttons.buildbutton(f"🔥 {config_dict['Group']}", f"{config_dict['https://t.me/st_leech']}")
    else:
